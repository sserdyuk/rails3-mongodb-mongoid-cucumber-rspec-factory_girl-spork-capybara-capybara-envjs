	...
	default_libraries = ['jquery', 'jquery-ui', 'rails']
    ActionView::Helpers::AssetTagHelper.register_javascript_expansion :jquery => default_libraries
	ActiveSupport.on_load(:action_view) do
	  ActiveSupport.on_load(:after_initialize) do
	    ActionView::Helpers::AssetTagHelper::register_javascript_expansion :defaults => default_libraries
	  end
	end
